-- all stg_books cols + author name+nationality + metrics + window_funcs
...
reach_metrics as (
    ...
    select book_id,
        ...
        round(count(distinct case when completion_pct=100 then user_id end) / count(distinct user_id), 2) as completion_rate,
